...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-slate-800 dark:text-white transition-colors duration-300">Tambah Data Pegawai</h1>
        <p class="text-slate-500 dark:text-slate-400 mt-1 transition-colors duration-300">Buat data profil pegawai baru di dalam sistem.</p>
    </div>
    ...
    <form action="{{ route('pegawai.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="pangkat" name="pangkat" value="{{ old('pangkat') }}"
        ...
        <div class="flex gap-3 mt-8 pt-4 border-t border-slate-100 dark:border-slate-700/50">
            ...
            <button type="submit"
                class="bg-indigo-600 text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200 dark:shadow-indigo-900/20">Simpan Pegawai</button>
        </div>
    </form>
</div>
@endsection