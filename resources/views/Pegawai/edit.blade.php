    ...
    <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="date" id="tmt_jabatan" name="tmt_jabatan" value="{{ old('tmt_jabatan', optional($pegawai->tmt_jabatan)->format('Y-m-d')) }}"
            ...
            <div>
                ...
                <div class="flex items-center gap-4 h-[42px]">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="hukuman_disiplin" value="1" {{ old('hukuman_disiplin', $pegawai->hukuman_disiplin ? '1' : '0') == '1' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="hukuman_disiplin" value="0" {{ old('hukuman_disiplin', $pegawai->hukuman_disiplin ? '1' : '0') == '0' ? 'checked' : '' }}
                            class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
